...
const IGRAGenForm = ({ handleUpdateIGRA, caseNumber }) => {
    // State hooks for IGRA information
    const [igraCaseNumber, setIGRACaseNumber] = useState("");
    ...
    const handleSubmit = async (event) => {
      ...
      try {
        ...
        // Add igra data to Firestore
        const docRef = await addDoc(collection(db, "igra"), igraData);
        console.log("Document written with ID: ", docRef.id);
    
        // Update IGRA if handleUpdateIGRA is provided
        if (handleUpdateIGRA) {
          const newIGRA = { ...igraData, id: docRef.id };
          handleUpdateIGRA(newIGRA);
        }
