...
const TSTGenForm = ({ handleUpdateTST, caseNumber }) => {
  // State hooks for TST information
  const [tstCaseNumber, setTSTCaseNumber] = useState("");
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // Add tst data to Firestore
      const docRef = await addDoc(collection(db, "tst"), tstData);
      console.log("Document written with ID: ", docRef.id);
  
      // Update TST if handleUpdateTST is provided
      if (handleUpdateTST) {
        const newTST = { ...tstData, id: docRef.id };
        handleUpdateTST(newTST);
      }
